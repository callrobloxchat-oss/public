...
-- ============================================================
--   COCONUTS + COCOON (fixed - no auto-delete)
-- ============================================================
local cocoClaimTime={}
SNO=nil
local SpawnToy=nil
            ...
            if rt then
                ...
                if folder then
                    ...
                    local function placeC(toy,off)
                        ...
                        if not (part and holdPart) then return end

                        trackedToys[toy]=true

                        if owner and owner.Value==LP.Name then
                            pcall(function()
                                part.CFrame=rt.CFrame*off*velOffset
                        ...
                        for _,p in ipairs(toy:GetChildren()) do
