...
-- Контейнер REC/помех (скрыт по умолчанию)
...
-- Управление скоростью (только для режима ракеты)
...
-- Анимация помех + таймкод (только когда hudActive)
