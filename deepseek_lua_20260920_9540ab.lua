...
local BSZInstr=Instance.new("TextLabel")
BSZInstr.Size=UDim2.new(1,0,0,64)
BSZInstr.BackgroundColor3=Color3.fromRGB(28,28,40)
BSZInstr.Text="Если хотите сломать дом — идите к незанятому дому, займите его и заспавните наковальню, потом нажмите Break Barrier, возьмите наковальню и идите к постройке и начинайте ломать наковальней постройку"
BSZInstr.TextColor3=Color3.fromRGB(150,180,230)
BSZInstr.Font=Enum.Font.Gotham
BSZInstr.TextSize=10
BSZInstr.TextWrapped=true
BSZInstr.TextYAlignment=Enum.TextYAlignment.Center
BSZInstr.LayoutOrder=75
BSZInstr.Parent=pgT
Instance.new("UICorner",BSZInstr).CornerRadius=UDim.new(0,6)
